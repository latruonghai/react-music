...
const Navbar = () => {
  ...
  return (
    <div
      className={
        scrolled
          ? 'w-full fixed z-20 bg-[#171717] drop-shadow-xl justify-between items-center flex'
          : 'w-full fixed top-0 right-0 z-20 bg-[#171717] justify-between items-center flex'
      }
    >
      <div className="relative pl-96 left-0">
        ...
        <input
          type="search"
          id="default-search"
          className="block p-3 pl-10 w-96 text-sm text-gray-900 dark:bg-stone-800 rounded-full focus:ring-blue-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500"
      ...
      <ul className="flex justify-end items-center">
        <div className="inline-flex pr-10 justify-center items-center">
          ...
          <div className="cursor-pointer mx-1 flex overflow-hidden relative items-center w-10 h-10 rounded-full ">
            <img
              src="https://scontent.fsgn13-4.fna.fbcdn.net/v/t39.30808-6/294393289_1446222785802572_5091573743168910914_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=hLeZq969FHYAX8Hjz0Q&tn=ydE2CFv-ou_JaohM&_nc_ht=scontent.fsgn13-4.fna&oh=00_AT-FHopiYled_3XMw06mJq5Ttss9VmZZwfBqzf2wTASFQg&oe=63249155"
              alt=""
            />
          </div>
        </div>
